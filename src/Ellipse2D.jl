...
@testset "ellipticArcLength test throws" begin
  @test_throws DomainError Geometry2D.ellipticArcLength( 20, 50, deg2rad(10), deg2rad(60) )
  @test_throws DomainError Geometry2D.ellipticArcLength( -20, 50, deg2rad(10), deg2rad(60) )
  @test_throws DomainError Geometry2D.ellipticArcLength( 20, -50, deg2rad(10), deg2rad(60) )
  @test_throws DomainError   Geometry2D.ellipticArcLength( 50, 20, deg2rad(200) )
  @test_throws DomainError Geometry2D.ellipticArcLength( 50, 20, deg2rad(-200) )
end
